...
clf1 = LocalJaccardDecisionTreeClassifier(watch=collect_stats1)
...
plt.plot(stats1[:,0], stats1[:,3], '--', label="Train Local Jaccard", color="red")
plt.plot(stats1[:,0], stats1[:,11], label="Test Local Jaccard", color="red")
plt.plot(stats2[:,0], stats2[:,3], '--', label="Train Global Jaccard", color="blue")
plt.plot(stats2[:,0], stats2[:,11], label="Test Global Jaccard", color="blue")
plt.ylabel('accuracy')
